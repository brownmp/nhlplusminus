...
```{r echo=FALSE}
data <- read.csv("~/Documents/BU/MA 681/Final Project /NEW/2007-2017.csv")
data_PP <- read.csv("~/Documents/BU/MA 681/Final Project /NEW/2007-2017_PP.csv")
#create row names 
...
ggplot(new,aes(G...game, colour = Pos))+
  geom_density()+
  ggtitle("Plus-Minus Distribution By Position")+ xlab("Plus-Minus") + ylab("Distribution")
```
